...
public class MainActivity extends AppCompatActivity {
    ...
    public void btnMethod(View view){
        ...
        style.addMessage("첫번쨰 메시지", System.currentTimeMillis(), user1);
        style.addMessage("두번쨰 메시지", System.currentTimeMillis(), user2);
        style.addMessage("세번쨰 메시지", System.currentTimeMillis(), user1);
        style.addMessage("네번쨰 메시지", System.currentTimeMillis(), user2);
